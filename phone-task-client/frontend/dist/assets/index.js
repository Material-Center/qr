      ...
      <section class="content">
        <header class="topbar">
          <div>
            ...
            <p class="version-line">\u7248\u672C ${s(e.status.version||"-")} / commit ${s(e.status.gitCommit||"-")}</p>
          </div>
