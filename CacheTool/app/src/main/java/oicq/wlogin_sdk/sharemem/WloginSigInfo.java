...
public class WloginSigInfo implements Serializable, Parcelable {
    ...
    public void SetSigInfo(long j, long j2, long j3, long j4, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, byte[] bArr7, byte[] bArr8, byte[] bArr9, byte[] bArr10, byte[] bArr11, byte[] bArr12, byte[][] bArr13, long[] jArr, int i) {
        ...
        if (bArr13 != null && bArr13.length == 16) {
            if (jArr != null && jArr.length == 7) {
                ...
                byte[] bArr162 = bArr13[2];
                if (bArr162 != null && bArr162.length > 0) {
                    this._D2 = (byte[]) bArr162.clone();
                ...
                byte[] bArr242 = this._DA2;
                if (bArr242 == null) {
                    util.LOGI("_DA2 is null", "");
                    length = 0;
                } else {
                    length = bArr242.length;
                }
                byte[] bArr26 = bArr13[11];
                if (bArr26 == null) {
                    util.LOGI("reserve[11] is null", "");
                    length2 = 0;
                } else {
                    length2 = bArr26.length;
                }
    ...
    public String toString() {
        try {
            ...
            String formatData = String.format(locale, "{A1:%d,%d A2:%d,%s pskey:%d,%d pt4token:%d wtST:%d da2:%d D2:%d,%d %d-%d}", objArr);
            return formatData + " tgt =" + util.byteArrayToHexString(this._TGT) + " tgtkey=" + util.byteArrayToHexString(this._TGTKey);
        } catch (Exception e) {
    ...
    public WloginSigInfo Set(byte[][] bArr, long j, long j2) {
        byte[] bArr2;
        util.LOGI("A1 version: [new version = " + j2 + "][old version = " + this._A1_version + "]", "");
        if (bArr != null && bArr.length == 5 && (bArr2 = bArr[0]) != null && bArr2.length > 0 && j2 >= this._A1_version) {
            this._A1_version = j2;
            Set(bArr, j);
        }
        return this;
