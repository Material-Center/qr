...
func (r *QQCacheRouter) InitQQCacheRouter(Router *gin.RouterGroup, PublicGroup *gin.RouterGroup) {
	...
	publicInternalToolRouter := PublicGroup.Group("internalTool")
	{
		...
		qqCacheRouterWithoutRecord.POST("exportAccountListByQQFile", qqCacheApi.ExportAccountListByQQFile)
		qqCacheRouter.POST("list", qqCacheApi.List)
		qqCacheRouterWithoutRecord.GET("accountTypes", qqCacheApi.AccountTypes)
		qqCacheRouterWithoutRecord.GET("salesAllowedAccountTypes", qqCacheApi.GetSalesAllowedAccountTypes)
		qqCacheRouter.PUT("salesAllowedAccountTypes", qqCacheApi.SaveSalesAllowedAccountTypes)
