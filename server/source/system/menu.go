...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	allMenus := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: 0, Path: "device-manage", Name: "deviceManage", Component: "view/device/deviceConfig.vue", Sort: 8, Meta: Meta{Title: "设备管理", Icon: "monitor"}},
	...
	childMenus := []SysBaseMenu{
		...
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["account"], Path: "manage", Name: "accountManage", Component: "view/account/accountManage.vue", Sort: 1, Meta: Meta{Title: "账号管理", Icon: "coordinate"}},
