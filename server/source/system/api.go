...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "Base", Method: "POST", Path: "/base/appLogin", Description: "App用户登录(免验证码，仅App角色)"},
		...
		{ApiGroup: "QQ缓存", Method: "POST", Path: "/qqCache/upload", Description: "App上传QQ缓存"},
		{ApiGroup: "QQ缓存", Method: "POST", Path: "/qqCache/extract", Description: "App提取QQ缓存"},
		{ApiGroup: "QQ缓存", Method: "POST", Path: "/qqCache/list", Description: "管理端分页查询QQ缓存"},
		{ApiGroup: "QQ缓存", Method: "POST", Path: "/qqCache/resetExtract", Description: "管理端重置提取锁"},
		{ApiGroup: "QQ缓存", Method: "POST", Path: "/qqCache/importZip", Description: "管理端导入QQ缓存zip"},
		...
		{ApiGroup: "QQ缓存", Method: "POST", Path: "/qqCache/exportAccountListByQQFile", Description: "管理端按TXT账号导出QQ账号列表(txt)"},
		...
		{ApiGroup: "QQ缓存", Method: "GET", Path: "/qqCache/sales/summary", Description: "销售查询缓存提取汇总"},
		...
		{ApiGroup: "QQ缓存", Method: "POST", Path: "/qqCache/uploadPhoneRegister", Description: "手机号注册上传QQ缓存并完成任务"},
		...
		{ApiGroup: "注册任务", Method: "GET", Path: "/registerTask/summary", Description: "获取反扫统计"},
		...
		{ApiGroup: "手机号注册任务", Method: "POST", Path: "/phoneRegisterTask/create", Description: "地推创建手机号注册任务"},
		{ApiGroup: "手机号注册任务", Method: "POST", Path: "/phoneRegisterTask/submitCode", Description: "地推提交手机号注册验证码"},
		{ApiGroup: "手机号注册任务", Method: "GET", Path: "/phoneRegisterTask/active", Description: "获取地推当前手机号注册任务"},
		{ApiGroup: "手机号注册任务", Method: "GET", Path: "/phoneRegisterTask/actives", Description: "获取地推全部手机号注册任务"},
		{ApiGroup: "手机号注册任务", Method: "POST", Path: "/phoneRegisterTask/list", Description: "分页查询手机号注册任务"},
		{ApiGroup: "手机号注册任务", Method: "GET", Path: "/phoneRegisterTask/summary", Description: "获取注册统计"},
		{ApiGroup: "手机号注册任务", Method: "POST", Path: "/phoneRegisterTask/settle", Description: "管理员结算团长手机号注册任务"},
		{ApiGroup: "手机号注册任务", Method: "GET", Path: "/phoneRegisterTask/settlement/history", Description: "管理员查询团长手机号注册结算历史"},
		{ApiGroup: "手机号注册任务", Method: "POST", Path: "/phoneRegisterTask/device/poll", Description: "设备拉取手机号注册任务"},
		{ApiGroup: "手机号注册任务", Method: "GET", Path: "/phoneRegisterTask/device/task", Description: "设备查询当前手机号注册任务"},
		{ApiGroup: "手机号注册任务", Method: "POST", Path: "/phoneRegisterTask/device/task", Description: "设备查询当前手机号注册任务"},
		...
		{ApiGroup: "手机号注册任务", Method: "POST", Path: "/phoneRegisterTask/open-api/promoter/receive-task", Description: "地推OpenAPI创建收码手机号注册任务"},
		{ApiGroup: "手机号注册任务", Method: "GET", Path: "/phoneRegisterTask/open-api/promoter/task/:taskId", Description: "地推OpenAPI查询手机号注册任务"},
		{ApiGroup: "手机号注册任务", Method: "POST", Path: "/phoneRegisterTask/open-api/promoter/submit-code", Description: "地推OpenAPI提交手机号注册验证码"},
	}
