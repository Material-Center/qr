...
type SysUser struct {
	...
	PhoneRegisterTaskDisabled        *bool          `json:"phoneRegisterTaskDisabled" gorm:"column:phone_register_task_disabled;default:false;comment:是否禁用创建手机号注册任务"`
	PhoneRegisterSkipBlockedPrefixes *bool          `json:"phoneRegisterSkipBlockedPrefixes" gorm:"column:phone_register_skip_blocked_prefixes;default:false;comment:是否跳过手机号注册禁用号段"`
